...
When creating our individual linear mixed models, we ofund that some states had significant impacts on the health measures (life expectancy, infant mortality, mortaltiy). We were curious if states were showing congruent signficance. For example, if Oregon had significantly higher life expectancy, did it also have significantly lower infant mortality and mortality? To explore this we created <a href="./images/congruence_map.png" title="Figure 12">Figure 12</a>, which shows positive outcomes and green and negative outcomes in red, with color intensity indicating congruence. 'Congruence' means that the state was significant for all 3 variables.'More' means that the state was negatively/positively significant for 2/3 variables, 'Slight' means the state was negatively/positively significant for 1/3, and 'Neutral' means the state was nit significant for any variables. Life expectancy was adjusted since it is considered positive while infant mortality and mortality are considered negative.

![Figure 12: Northwestern States Have Best Life Expectancy, Infant Mortality, and Mortality Outcomes.](./images/congruence_map.png)
...
![Figure 13: caption](./Figures/kbest_mortality.png)
