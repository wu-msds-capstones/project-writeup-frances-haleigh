...
Additional Kaplan-Meier Curves for life expectancy were made for the following variables: `PCP Ratio`, `Segregation Index`, and `Percentage of Broadband Internet Access`. Log rank tests were performed for each, and all of the results were significant (not shown here). <a href="./images/KM_PCPratio.png" title="Figure 9">Figure 9</a> shows each of the KM curves.

::: {layout-ncol=3}
![Figure 9a: Having less PCPs available in a community reduces life expectancy.](./images/KM_PCPratio.png){group="km_gallery"}

![Figure 9b: Living in a more segregated community (ratio of Blacks versus Whites) reduces life expectancy.](./images/KM_Segregation.png){group="km_gallery"}

![Figure 9c: Having reduced access to internet reduces life expectancy.](./images/KM_broadband.png){group="km_gallery"}

Significant differences exist between each feature's quartiles. This suggests that lower access to care (`PCP Ratio` and `Percentage of Broadband Internet Access`) and more segregated areas (`Segregation Index`) have lower life expectancies. 
:::
...
![Figure 9: caption](./Figures/kbest_life_exp.png)
