...
![Figure 4: Percent of population with access to exercise is most associated with the variance described in the first eigenvalue. `CHLAMYDIA_RATE` has the least. Since the first eigenvalue is most described by`YEARS_OF_POTENTIAL_LIFE_LOST_RATE`, that means access to exercise and chlamydia rate describe this mortality metric the most and least, respectively.](./Figures/overall_health_all_variables.png)
