...
![Figure 5: There is a clear geographic trend where the southeastern states have higher projection trends and the northwestern have lower. Since the first eigenvalue is most explained by `YEARS_OF_POTENTIAL_LIFE_LOST_RATE`, southeastern states have higher rates and northwestern lower.](./Figures/state_projection.png)
