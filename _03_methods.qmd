...
3. Create Model
    ...
    ii) Select signfiicant features for each, and recreate model with signfiicant features. Ensure no multicollinearity existed between remaining variables.
...
3. Use KMeans to find the top 10 features from each model. (See <a href="./Figures/kbest_life_exp.png" title="Figure 10">Figures 10</a>, and <a href="./Figures/kbest_mortality.png" title="Figure 17">17</a>). Combine these variables with significant variables from the linear regression models completed in R.
