...
3. Use KMeans to find the top 10 features from each model (see <a href="_08_supplemental.qmd#supplemental-figures" title="![Figure 1A](./Figures/kbest_life_exp_1A.png) ![Figure 1B](./Figures/kbest_life_exp_1B.png) ![Figure 1C](./Figures/kbest_life_exp_1C.png)">Supplemental Figures 1A-C</a>). (see [Supplemental Figures 1A-C](_08_supplemental.qmd#supplemental-figures)). Combine these variables with significant variables from the linear regression models completed in R.
