...
3. Create Model
    ...
    ii) Select signfiicant features for each, and recreate model with signfiicant features. Ensure no multicollinearity existed between remaining variables (see <a href="./images/LE_pairs.png" title="Figures S.4a">Figures S.4a</a> through <a href="./images/M_assumptions.png" title="Figure S.5C">S.5C</a>).
