...
flowchart TD
  A(1. Create Dataset) --> B(2. Scale Dataset)
  B --> C(3. LM Model, reduce data \nto best features)
  C --> D(4. KM Curves \n for Life Expectancy features)
  D --> E(5. Log Rank Test \n for KM curves)
```
...
3. Create Model
    ...
    ii) Select signficant features for each, and recreate model with signfiicant features. Ensure no multicollinearity existed between remaining variables (see <a href="./images/LE_pairs.png" title="Figures S.4a">Figures S.4a</a> through <a href="./images/M_assumptions.png" title="Figure S.5C">S.5C</a>).
...
3. Use KMeans to find the top 10 features from each model. (See <a href="./Figures/kbest_life_exp.png" title="Figure 9">Figures 9</a>, and <a href="./Figures/kbest_mortality.png" title="Figure 12">12</a>). Combine these variables with significant variables from the linear regression models completed in R.
